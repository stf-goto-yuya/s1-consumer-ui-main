...
import { AlertViewButton } from '@/src/components/admin/alerts/view-button'
...
export const AlertTable: React.FC<Props> = ({ columns, data }) => {
        ...
        {rows.map((row: any, i) => {
          ...
          return (
            ...
            >
              ...
              <Td>
                <Flex>
                  <AlertViewButton id={row.original.id} />
                </Flex>
              </Td>
            </Tr>
          )
